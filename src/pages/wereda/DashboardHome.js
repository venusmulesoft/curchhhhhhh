            ...
            <div key={index} className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="mt-4 flex items-center">
                <TrendingUp className={`h-4 w-4 ${
                  card.changeType === 'positive' ? 'text-success-500' : 'text-danger-500'
                }`} />
              ...
              {quickActions.map((action, index) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full p-4 rounded-lg border border-gray-200 hover:shadow-md transition-all duration-200 ${action.color}`}
                  >
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-3 p-3 bg-primary-50 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Every Sunday at 9:00 AM</p>
              </div>
            </div>
            <div className="flex items-center space-x-3 p-3 bg-success-50 rounded-lg">
              <Calendar className="h-5 w-5 text-success-600" />
              <div>
                <p className="font-medium text-gray-900">Baptism Ceremony</p>
                <p className="text-sm text-gray-600">Next Sunday at 2:00 PM</p>
              </div>
            </div>
            <div className="flex items-center space-x-3 p-3 bg-warning-50 rounded-lg">
              <Calendar className="h-5 w-5 text-warning-600" />
              <div>
                <p className="font-medium text-gray-900">Sunday School</p>
                <p className="text-sm text-gray-600">Every Sunday at 10:30 AM</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <span className="text-gray-600">Believers by Role</span>
            ...
            <div className="flex justify-between items-center">
              <span className="text-gray-600">Believers by Gender</span>
              <span className="font-medium text-gray-900">75M / 75F</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2">
            ...
            <div className="flex justify-between items-center">
              <span className="text-gray-600">Monthly Baptisms</span>
              <span className="font-medium text-gray-900">2.1 avg</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2">
